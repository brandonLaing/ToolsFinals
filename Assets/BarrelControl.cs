...
public class BarrelControl : MonoBehaviour
{
  ...
  public void Fire()
  {
    ...
    {
      Debug.LogError("Fired bellow cooldown");
      return;
    }
  ...
  /// </summary>
  /// <returns></returns>
  public float GetEstimatedShotLandingTime()
  {
  ...
  /// </summary>
  /// <returns></returns>
  public Vector3 GetEstimatedShotLandingLocation()
  {
    float shellRadius = shellPrefab.transform.localScale.y * 0.5f;
    Vector3 startLocation = shellSpawn.position;
    Vector3 startVelocity = shellSpawn.forward * launchSpeed;
  ...
  private void OnDrawGizmos()
  {
    ...
    Gizmos.DrawSphere(GetEstimatedShotLandingLocation(), 1);
  }
